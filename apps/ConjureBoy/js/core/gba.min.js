...
/* --- BUNDLED FILE: video/software.js --- */
...
GameBoyAdvanceSoftwareRenderer.prototype.freeze = function() {
	var palMem = new Uint16Array(512);
	for (var i = 0; i < 512; ++i) {
		palMem[i] = this.palette.loadU16(i << 1);
	}
	return {
		'palette': Serializer.prefix(palMem.buffer),
